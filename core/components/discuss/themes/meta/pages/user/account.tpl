...
<form action="[[~[[*id]]]]user/account?user=[[+id]]" method="post" id="dis-user-account-form" style="border: 0;">
    ...
    <input type="text" name="username" id="dis-username" value="[[+username]]" /><br />
    
    <label for="dis-email">[[%discuss.email]]:
        <span class="error">[[+error.email]]</span>
    </label><br />
    <input type="text" name="email" id="dis-email" value="[[+email]]" /><br />
    ...
    <input type="password" name="password_new" id="dis-password-new" /><br />
    
    <label for="dis-password-confirm">[[%discuss.password_confirm]]:
        <span class="error">[[+error.password_confirm]]</span>
    </label><br />
    <input type="password" name="password_confirm" id="dis-password-confirm" /><br />
